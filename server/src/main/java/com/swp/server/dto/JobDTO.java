...
public class JobDTO {
    ...
    public JobDTO(int category_Id, String career_Level, Integer experience, String offer_Salary, String qualification, String job_Type, String description, Date apply_Before, String address) {
