...
public class EmployerServiceImpl implements EmployerService{
    ...
    public ResponseEntity<?> viewJobSeekerProfile(ViewProfileDTO viewProfileDTO) {
        try{
            ...
            ResponseProfileDTO profileResponse = getResponseProfileDTO(profile, account);
    ...
    private static ResponseProfileDTO getResponseProfileDTO(Profile profile, Account account) {
