...
export class ManageJobComponent implements OnInit {
  ...
  initialUpdateForm(): void {
    ...
    this.updateForm = new FormGroup({
      ...
      Apply_Before: new FormControl(formattedDate, [
        Validators.required,
        this.applyBeforeValidator,
      ]),
  ...
  handleOk(): void {
    ...
    if (this.addForm.get('name')!.invalid || this.updateForm.get('name')!.value.trim() === '') {
    ...
    } else if (this.addForm.get('address')!.invalid || this.updateForm.get('address')!.value.trim() === '') {
      this.isAddSpinning = false;
      this.msg.error('Vui lòng không để trống trường địa chỉ !!!');
    } else if (this.addForm.get('description')!.invalid || this.updateForm.get('description')!.value.trim() === '') {
      this.isAddSpinning = false;
  ...
  handleOkUpdate(): void {
    ...
    if (this.updateForm.get('name')!.invalid || this.updateForm.get('name')!.value.trim() === '') {
    ...
    } else if (this.updateForm.get('address')!.invalid || this.updateForm.get('address')!.value.trim() === '') {
      this.isUpdateSpinning = false;
      this.msg.error('Vui lòng không để trống trường địa chỉ !!!');
    } else if (this.updateForm.get('description')!.invalid || this.updateForm.get('description')!.value.trim() === '') {
      this.isUpdateSpinning = false;
      this.msg.error('Vui lòng không để trống trường mô tả !!!');
    } else {
      const formData = new FormData();
      ...
      this.jobService.updateJob(formData).subscribe(
        (res) => {
          ...
          this.msg.success('Job updated successfully !!!');
          this.jobService.getAllJob().subscribe(
            (res) => {
              this.isUpdateSpinning = false
              this.listJob = res;
            ...
            (err) => {
              this.msg.error('Error occurred while fetching jobs !!!');
              this.listJob = null;
              this.handleCancelUpdate()
            }
          );
